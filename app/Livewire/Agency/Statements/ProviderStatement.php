...
class ProviderStatement extends Component
{
    ...
    // app/Livewire/Agency/Statements/ProviderStatement.php
...
public function rebuild(): void
{
    ...
    // ✅ كل سطر = بيع للمزوّد بقيمة usd_sell (له)
    ...
    public function exportPdf(?string $scope='all')
    {
        ...
        $payload = base64_encode(json_encode([
            ...
            'rows'=>$rows,
            'totals'=>['count'=>count($rows),'debit'=>$this->sumDebit,'credit'=>$this->sumCredit],
        ]));
    ...
    public function render(){ return view('livewire.agency.statements.provider-statement', ['provider'=>$this->provider,'statement'=>$this->statement]); }
}
