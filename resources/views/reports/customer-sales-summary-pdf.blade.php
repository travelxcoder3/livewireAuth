...
<head>
    <meta charset="UTF-8">
    <title>كشف تتبّع عمليات العملاء (ملخص)</title>
    <style>
        @page { margin: 30px; }
...
<div class="header">
    ...
    @else
        <div class="logo"></div>
    @endif
    <div class="title">كشف تتبّع عمليات العملاء (ملخص)</div>
    <div></div>
</div>
...
<div class="period" style="margin-top:10px">
    إجمالي العملاء: {{ is_countable($perCustomer ?? []) ? count($perCustomer) : 0 }}<br>
