...
<head>
    <meta charset="UTF-8">
    <title>كشف عمليات المزوّد - {{ $provider?->name }}</title>
    <style>
        @page { margin: 30px; }
...
<body>
    ...
    <div class="header">
        ...
        @else
            <div class="logo"></div>
        @endif
        <div class="title">كشف عمليات المزوّد</div>
        <div></div>
    </div>

    {{-- معلومات عامة --}}
    <div class="sub">
        <span class="chip">المزوّد: {{ $provider?->name ?? '—' }}</span>
    ...
    <table>
        <colgroup>
            ...
            <col style="width:16%"><col style="width:16%"><col style="width:20%">
        </colgroup>
        <thead>
        <tr>
            <th>الخدمة</th>
