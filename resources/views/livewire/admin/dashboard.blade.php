    ...
    <div class="flex flex-col lg:flex-row gap-8 items-stretch">
        ...
        <div class="w-full lg:w-3/4">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 h-full">
                <!-- كرت مدراء الوكالات -->
                <div class="group rounded-3xl shadow-2xl p-6 flex flex-col items-center justify-center gap-4 transition-transform duration-200 hover:scale-105 cursor-pointer min-h-[220px] h-full bg-white">
                    <div class="rounded-full p-3 shadow-lg mb-2" style="background-color: rgba(var(--primary-500), 0.1); color: rgb(var(--primary-500));">
                        ...
                        <tr class="transition hover:bg-[rgba(var(--primary-500),0.08)]">
                            ...
                            <td class="px-4 py-2">
                                @if($agency->status === 'active')
                                    <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full" style="background-color: rgba(var(--primary-500), 0.1); color: rgb(var(--primary-500));">نشطة</span>
                                @else
                                    <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full" style="background-color: rgba(239, 68, 68, 0.1); color: rgb(239, 68, 68);">معلقة</span>
                                @endif
                            </td>
                        </tr>
                    @empty
