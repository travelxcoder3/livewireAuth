...
<!-- تحسينات للموبايل فقط ≤640px -->
<style>
@media (max-width:640px){
  /* فلاتر */
  .empcol-filters{grid-template-columns:1fr !important; padding-top:2.25rem}
  .empcol-filters .reset-abs{position:static !important; inset:auto !important; width:100%}
  .empcol-filters .reset-abs > button{width:100%}

  /* جدول */
  .empcol-table{font-size:12px}
  .empcol-table table th,
  .empcol-table table td{padding:.35rem .5rem}
}
</style>
...
<div class="space-y-6">
  ...
  <div class="bg-white rounded-xl shadow p-4 grid md:grid-cols-4 gap-3 text-sm items-end relative empcol-filters">
    ...
    <!-- زر مسح الفلاتر (يبقى absolute للديسكتوب، يصبح ممتد للموبايل) -->
    <div class="absolute top-4 left-4 reset-abs">
      <button
          wire:click="resetFilters"
          class="w-36 h-9 rounded-lg shadow text-sm font-medium
  ...
  <!-- الجدول -->
  <div class="bg-white rounded-xl shadow empcol-table">
