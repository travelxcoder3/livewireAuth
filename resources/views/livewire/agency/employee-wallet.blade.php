...
<div class="fixed inset-0 z-[70] flex justify-end">
  ...
  <!-- اللوحة -->
  <div class="relative z-[70] w-full sm:w-[520px] bg-white h-screen shadow-2xl p-5 overflow-y-auto">
    ...
    <div class="flex items-center justify-between">
      <div>
        <div class="text-sm text-gray-500">حساب الموظف</div>
    ...
    <!-- نموذج عملية جديدة (نفس مكونات العميل) -->
    ...
    <div class="grid grid-cols-2 gap-2 text-sm">
      <x-date-picker name="from" wireModel="from" label="من تاريخ" placeholder="اختر التاريخ" />
      <x-date-picker name="to"   wireModel="to"   label="إلى تاريخ" placeholder="اختر التاريخ" />
