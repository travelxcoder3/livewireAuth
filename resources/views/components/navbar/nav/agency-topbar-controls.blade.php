...
<div class="flex items-center gap-1 sm:gap-3 rtl:flex-row-reverse" x-data="{ openDropdown: '' }">
    ...
    <div class="relative" @mouseenter="openDropdown = 'theme'" @mouseleave="openDropdown = ''">
        ...
        <div x-show="openDropdown === 'theme'" x-transition
            ...
            bg-gray-800 rounded-md shadow-lg border border-gray-100 border-gray-700 z-50 p-2"
            style="display: none;">
    ...
    <div class="relative" @mouseenter="openDropdown = 'lang'" @mouseleave="openDropdown = ''">
        ...
        <div x-show="openDropdown === 'lang'" x-transition
            class="absolute left-0 top-full mt-1 bg-white bg-gray-800 rounded-lg shadow-xl border border-gray-100 border-gray-700 py-2 z-50 min-w-[160px]">
    ...
    <div class="relative" @mouseenter="openDropdown = 'notifications'" @mouseleave="openDropdown = ''">
        ...
        <div x-show="openDropdown === 'notifications'" x-transition
            class="absolute left-0 top-full mt-1 bg-white bg-gray-800 rounded-lg shadow-xl border border-gray-100 border-gray-700 py-2 z-50 w-[320px] max-h-[400px] overflow-y-auto">
    ...
    <div class="relative" @mouseenter="openDropdown = 'user'" @mouseleave="openDropdown = ''">
        ...
        <div x-show="openDropdown === 'user'" x-transition
            class="absolute left-0 top-full mt-1 bg-white bg-gray-800 rounded-lg shadow-xl border border-gray-100 border-gray-700 py-2 z-50 min-w-[240px]">
