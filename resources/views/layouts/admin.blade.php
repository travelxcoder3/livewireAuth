        ...
        <div class="flex items-center gap-1 sm:gap-2 h-full">
            @php
                $navLinks = [
                    ...
                    ['route' => 'admin.agencies', 'label' => 'إدارة الوكالات', 'icon' => 'M16 3v4M8 3v4M3 10h18'],
                    ['route' => 'admin.add-agency', 'label' => 'إضافة وكالة', 'icon' => 'M20 8v6M23 11h-6'],
                    ['route' => 'admin.dynamic-lists', 'label' => 'القوائم', 'icon' => 'M4 6h16M4 12h16M4 18h16'],
                ];
            @endphp
