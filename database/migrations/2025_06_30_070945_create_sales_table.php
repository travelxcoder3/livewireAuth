...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('sales', function (Blueprint $table) {
            ...
            $table->string('action')->nullable(); // مثل: إصدار - إلغاء
            $table->decimal('usd_buy', 12, 2)->nullable();   // سعر الشراء بالدولار
            $table->decimal('usd_sell', 12, 2)->nullable();  // سعر البيع بالدولار
            $table->decimal('amount_received', 12, 2)->nullable(); // المبلغ المدفوع من العميل
